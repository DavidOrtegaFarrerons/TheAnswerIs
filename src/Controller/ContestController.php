...
class ContestController extends AbstractController
{
    ...
    #[Route('/contests', name: 'create_contest', methods: ['POST'])]
    ...
    #[Route('/contests/edit/{contest}', name: 'edit_contest', methods: ['GET'])]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/contests/edit/{contest}/publish', name: 'publish_contest', methods: ['POST'])]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/contests/edit/{contest}/unpublish', name: 'unpublish_contest', methods: ['POST'])]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
