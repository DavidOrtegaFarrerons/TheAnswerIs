 ...
 */
final class Version20250807190001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contest (id UUID NOT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, total_questions INT NOT NULL, allowed_jokers JSON NOT NULL, difficulty_curve JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE question (id UUID NOT NULL, contest_id UUID NOT NULL, title VARCHAR(255) NOT NULL, option_a VARCHAR(255) NOT NULL, option_b VARCHAR(255) NOT NULL, option_c VARCHAR(255) NOT NULL, option_d VARCHAR(255) NOT NULL, correct_answer VARCHAR(255) NOT NULL, difficulty VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B6F7494E7339EE7F ON question (contest_id)');
        $this->addSql('COMMENT ON COLUMN question.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN question.contest_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE round (id UUID NOT NULL, game_id UUID NOT NULL, question_id UUID NOT NULL, question_number INT NOT NULL, shown_answers JSON NOT NULL, preselected_answer VARCHAR(255) DEFAULT NULL, confirmed_answer VARCHAR(255) DEFAULT NULL, is_correct BOOLEAN DEFAULT NULL, started_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, finished_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, used_jokers JSON NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494E7339EE7F FOREIGN KEY (contest_id) REFERENCES contest (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
